...
import com.brunostaine.api.gestor.financeiro.web.exceptions.ErrorMessage;
...
@Tag(name = "Usuarios", description = "Recurso para trabalhar com usuários")
...
public class UsuarioController {
    ...
    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody UsuarioCreateDTO createDTO) {
    ...
    @Operation(summary = "Listar todos os usuários cadastrados", description = "Requisição exige um Bearer Token.",
            security = @SecurityRequirement(name = "security"),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recurso recuperado com sucesso", content = @Content(mediaType = "application/json",
